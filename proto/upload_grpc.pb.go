...
const (
	UploadService_UploadFile_FullMethodName = "/upload_service.UploadService/UploadFile"
)
...
type UploadServiceClient interface {
	UploadFile(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[UploadStream, UploadResponse], error)
}
...
func (c *uploadServiceClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[UploadStream, UploadResponse], error) {
	...
	x := &grpc.GenericClientStream[UploadStream, UploadResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type UploadService_UploadFileClient = grpc.ClientStreamingClient[UploadStream, UploadResponse]

// UploadServiceServer is the server API for UploadService service.
// All implementations must embed UnimplementedUploadServiceServer
// for forward compatibility.
type UploadServiceServer interface {
	UploadFile(grpc.ClientStreamingServer[UploadStream, UploadResponse]) error
...
func (UnimplementedUploadServiceServer) UploadFile(grpc.ClientStreamingServer[UploadStream, UploadResponse]) error {
...
func _UploadService_UploadFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(UploadServiceServer).UploadFile(&grpc.GenericServerStream[UploadStream, UploadResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type UploadService_UploadFileServer = grpc.ClientStreamingServer[UploadStream, UploadResponse]
...
var UploadService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "upload_service.UploadService",
